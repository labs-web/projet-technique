...
**Exemple : SKILL `developpeur-http`**
...
### Exemple 1 : SKILL d'Installation (`configurateur-stack`)
...
### Exemple 2 : SKILL de Développement (`developpeur-frontend`)
...
### Exemple 3 : SKILL de Configuration (`developpeur-data`)
...
**Exemple dans `developpeur-http/SKILL.md` :**
...
1. Si la fonctionnalité nécessite des autorisations complexes :
   - Consulter le skill `developpeur-business`
   - Appliquer les règles définies dans `developpeur-business/resources/policies.md`
...
│       ├── authentication.md
│       └── xss-prevention.md
├── developpeur-http/         ← Consulte expert-security
└── developpeur-frontend/      ← Consulte expert-security
```

**Référencement dans `developpeur-http/SKILL.md` :**
